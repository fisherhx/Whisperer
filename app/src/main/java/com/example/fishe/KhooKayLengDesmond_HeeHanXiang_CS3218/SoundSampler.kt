...
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.MainActivity.Companion.FFT_Len
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.MainActivity.Companion.FS
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.MainActivity.Companion.bufferSize
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.MainActivity.Companion.buffer
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.MainActivity.Companion.soundFFTMag
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.MainActivity.Companion.mx
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.MainActivity.Companion.offset
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.MainActivity.Companion.startPw
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.MainActivity.Companion.endPw
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.SoundReceiver.Companion.msg
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.SoundReceiver.Companion.prevIndex
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.SoundReceiver.Companion.currCount
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.SoundReceiver.Companion.isRepeated
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.SoundReceiver.Companion.isCounted
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.SoundReceiver.Companion.count
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.SoundReceiver.Companion.isEnd
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.SoundReceiver.Companion.isStarted
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.SoundReceiver.Companion.repeatedWord
import com.example.fishe.KhooKayLengDesmond_HeeHanXiang_CS3218.SoundReceiver.Companion.singalRecieved
...
class SoundSampler(activity: SoundReceiver) {
    ...
    fun performFFT() {
        ...
        //Received start signal, enable message appending
        if(index == startPw){
            isStarted = true
            Log.i("Max Started", "start")
        }
        //Recieved end signal, stop appending msg
        else if(index == endPw){
            isEnd = true
            Log.i("Max Ended", "end")
        }
        //Received this before allowing each char to append
        //Used to prevent error in freq recorded due to transitioning to next one
        if(index == 205){
            singalRecieved = true
        }

        if(index > 9 && index < 197 && singalRecieved) {
